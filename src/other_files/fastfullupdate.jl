...
function fastfullupdate(temperature,J1::Float64,J2::Float64,h::Float64,hs::Float64,dbetafu::Float64,C::Vector{lattice},
    ...
    while temp > temperature[end] 
        ...
        if (temperature[relevant] <= tempprev && temperature[relevant] > temp) 
            ...
            PPS = 1/6*(PartitionPerSite(T,C,tens_a,gt,1,1) + PartitionPerSite(T,C,tens_a,gt,3,1) + 
            PartitionPerSite(T,C,tens_a,gt,5,1)) + 2*free_energy/3
