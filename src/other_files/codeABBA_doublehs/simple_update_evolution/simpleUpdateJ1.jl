...
function simpleupdateJ1(Gamma::lattice2x1,lambdax::lattice2x1,lambday::lattice2x1,
    ...
    Gamma,lambdax, ffx1,DW1 = thermal_evolve_x(Gamma,lambdax,lambday,physical_legs,gx2,gt,D)
    Gamma,lambday, ffy, DW2 = thermal_evolve_y(Gamma,lambdax,lambday,physical_legs,gy,gt,D)
    Gamma,lambdax, ffx2,DW3 = thermal_evolve_x(Gamma,lambdax,lambday,physical_legs,gx2,gt,D)
    ...
    return Gamma,lambdax,lambday, FreeEnergy, DW
