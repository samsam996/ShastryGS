...
function fullupdate(temperature,J1::Float64,J2::Float64,h::Float64,hs::Float64,dbetafu::Float64,C::Vector{lattice2x1},
    T::Vector{lattice2x1},tens_a::lattice2x1,tens_A::lattice2x1,cxd::lattice2x1,cyd::lattice2x1,
    physical_legs::lattice_ind2x1,ancilla_legs::lattice_ind2x1,gt::Matrix{Symbol},gg::Matrix{Symbol},
    ...
    while temp > temperature[end] 
        ...
        @show temp, it
        full_update!(tens_a,tens_A,cxd,cyd,gt,physical_legs,ancilla_legs,gx,gy,D,C,T)
