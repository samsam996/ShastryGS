...
function horizontal_correlation(C::Vector{lattice2x1},T::Vector{lattice2x1},
    tens_a::lattice2x1,tens_A::lattice2x1,gt,cx::lattice2x1,cy::lattice2x1,
    physical_legs::lattice_ind2x1,entanglement_legs::lattice_ind2x1,i::Int64,j::Int64)
