...
"""
function magnetisation_one_site(C::Vector{lattice2x1},T::Vecto{lattice2x1},tens_a_raw,tens_a,tens_A,gt,ind_x,ind_y,indx_a,indy_a,c_x_a,c_y_a,entanglement_legs,i,j)
