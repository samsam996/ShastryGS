...
function magnetisation(C::Vector{lattice2x1},T::Vector{lattice2x1},
    tens_a::lattice2x1,tens_A::lattice2x1,gt::Matrix{Symbol},cxd::lattice2x1,
    cyd::lattice2x1,physical_legs::lattice_ind2x1,entanglement_legs::lattice_ind2x1)
