...
function find_value(C,T,P,
    ...
    del::Array{Vector},dr::Array{Vector},theta::Int64,mp::Vector{Int64},mm::Vector{Int64},i::Int64,j::Int64,N::Int64)
    ...
    getfield(tens,gt[f(i),f(j)]))*
    getfield(Ptilde,gt[f(i),f(j)])
